...
public class Food {
	...
	public Food(int cuisineId, String name, String description, String imageName,double price) {
	...
	// getter and setter of cuisineId
	public int getCuisineId() {
		return this.cuisineId;
	}
	public void setCuisinId(int cuisineId) {
		this.cuisineId=cuisineId;
	}
